...
interface IOrderRepository {
    ...
    suspend fun getOrderListByCafeUuid(cafeUuid: UUID, limitTimeMillis: Long): List<GetCafeOrder>
    suspend fun getOrderListByCompanyUuid(companyUuid: UUID, limitTimeMillis: Long): List<GetCafeOrder>
